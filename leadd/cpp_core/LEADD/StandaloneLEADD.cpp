...
int main(int argc, const char* argv[]) {
  ...
  // Fetch LEADD's settings and verify that the scoring function is well defined.
  const ReconstructionSettings& settings = leadd.GetSettings();
  ...
  std::experimental::filesystem::path output_molecules_path (output_directory);
